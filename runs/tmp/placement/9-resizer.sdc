...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {pop}]
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {push}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {pop}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {push}]
